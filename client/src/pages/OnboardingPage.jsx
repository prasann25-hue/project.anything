...
export const OnboardingPage = () => {
  ...
  const handleToggleKnownTech = (tech) => {
  ...
  const handleToggleWeakTech = (tech) => {
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                {errors.known_technologies && <p className="text-xs text-red-400 mt-2 flex items-center gap-1">{errors.known_technologies.message}</p>}
              </div>
              ...
              <div>
                ...
                {errors.weak_technologies && <p className="text-xs text-red-400 mt-2 flex items-center gap-1">{errors.weak_technologies.message}</p>}
              </div>
            </div>
