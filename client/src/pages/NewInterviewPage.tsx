...
import { InterviewSetupSchema } from '../validation/schemas';
import { api } from '../lib/api';
import { z } from 'zod';

type SetupFormValues = z.infer<typeof InterviewSetupSchema>;
...
export const NewInterviewPage: React.FC = () => {
  ...
  // Reset topic selection if the role changes
  useEffect(() => {
    if (topics.length > 0) {
      ...
      <div className="bg-[#0d1222]/40 border border-gray-800 rounded-3xl p-8 shadow-xl shadow-black/30">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            {/* Topic selection - dynamically derived */}
            <div>
